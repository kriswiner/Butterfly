/* LSM9DS1_MS5611_Butterfly Basic Example Code
 by: Kris Winer
 date: March 7, 2017
 ...
 This sketch is intended specifically for the LSM9DS1+MS5611 Add-on shield
 https://www.tindie.com/products/onehorse/lsm9ds1ms5611-breakout-board/.
 
 It uses SDA/SCL on pins 20/21, respectively, and it uses the Wire library Wire.h.
 ...
 4K7 resistors are on the LSM9DS1+MS5611 add-on shield/breakout board.
 
 Hardware setup:
 LSM9DS1Breakout --------- Butterfly
 VDD ---------------------- 3.3V
 SDA ----------------------- 20
 SCL ----------------------- 21
 GND ---------------------- GND
...
//  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, -mx, my, mz);
    ...
    temperature = ((float) tempCount)/16. + 25.0; // Gyro chip temperature in degrees Centigrade
...
int16_t readTempData()
{
  ...
  return (int16_t) (((int16_t)rawData[1] << 8) | rawData[0]);  // Turn the MSB and LSB into a 16-bit signed value
}
...
// I2C read/write functions for the LSM9DS1 sensors
