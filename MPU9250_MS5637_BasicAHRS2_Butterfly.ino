/* MPU9250_MS5637_BasicAJRS2_Butterfly Basic Example Code
 by: Kris Winer
 ...
 Mahony filter algorithms. Sketch runs on the 3.3 V 80 MHz Butterfly STM32L433 devbelopment board.
...
// Start device display with ID of sensor
  ...
  display.setCursor(0, 20); display.print("MPU9250");
  display.setCursor(0,40); display.print("MS5637");
...
// Second order corrections
 ...
 //
    ...
    Serial.print("Altitude = "); Serial.print(altitude, 2); Serial.println(" feet");
      ...
      display.setCursor(0,20); display.print("T "); display.print(Temperature, 1); display.print(" C "); display.print(9.0f*(Temperature)/5.0f + 32.0f, 1); display.println(" F");
      display.setCursor(0,30); display.print("A "); display.print((int)1000*ax); display.print(" "); display.print((int)1000*ay); display.print(" "); display.print((int)1000*az); display.print(" mg");
      display.setCursor(0,40); display.print("G "); display.print(gx); display.print(" "); display.print(gy); display.print(" "); display.print(gz); display.print(" dps");
      display.setCursor(0,50); display.print("M "); display.print((int) mx); display.print(" "); display.print((int) my); display.print(" "); display.print((int) mz); display.print(" mG");  
      display.refresh();
      }
...
// MS5637 registers
        ...
        void MS5637Reset()
        {
        writeByte(MS5637_ADDRESS, MS5637_RESET, NULL);
        }
